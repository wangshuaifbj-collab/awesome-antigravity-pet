...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "en": {
        "app_title": "Antigravity Desktop Pet Companion",
        "ready": "{name} is ready! ✨",
        "switched": "Switched to: {name} 💖",
        "wave_greeting": "Hi there! ✨",
        "task_completed": "✨ Task complete! Check it out~ 🚀",
        "thinking": "Thinking of optimal solutions... 💡",
        "coding": "Writing code... 💻",
        "failed": "Encountered an issue... ⚠️",
